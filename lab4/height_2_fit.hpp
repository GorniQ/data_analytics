...
{" (found before start of program)",
 ...
 " (in '/home/lab4/height_2_fit.stan', line 21, column 3 to column 27)",
 " (in '/home/lab4/height_2_fit.stan', line 22, column 3 to column 24)",
 ...
 public:
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    try {
      ...
      std::vector<local_scalar_t__> mi =
         std::vector<local_scalar_t__>(N, DUMMY_VAR__);
      current_statement__ = 7;
      for (int i = 1; i <= N; ++i) {
        current_statement__ = 5;
        stan::model::assign(mi,
          ((beta *
             stan::model::rvalue(weight, "weight", stan::model::index_uni(i)))
            + alpha), "assigning variable mi", stan::model::index_uni(i));
      }
      {
        current_statement__ = 12;
        lp_accum__.add(stan::math::normal_lpdf<propto__>(alpha, 154, 10));
        current_statement__ = 13;
        lp_accum__.add(stan::math::gamma_lpdf<propto__>(sigma, 1, 15));
      ...
      for (int i = 1; i <= N; ++i) {
        ...
        stan::model::assign(h,
          stan::math::normal_rng(
            stan::model::rvalue(mi, "mi", stan::model::index_uni(i)), sigma,
  ...
  inline void get_param_names(std::vector<std::string>& names__) const {
    ...
    names__ = std::vector<std::string>{"alpha", "sigma", "beta", "mi", "h"};
  ...
  inline void constrained_param_names(
    ...
    if (emit_transformed_parameters__) {
      for (int sym1__ = 1; sym1__ <= N; ++sym1__) {
        {
          param_names__.emplace_back(std::string() + "mi" + '.' + std::to_string(sym1__));
        } 
      }
    }
  ...
  inline std::string get_constrained_sizedtypes() const {
    ...
    return std::string("[{\"name\":\"alpha\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"sigma\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"beta\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"mi\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(N) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"},{\"name\":\"h\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(N) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"generated_quantities\"}]");
